module github.com/helios/go-sdk/proxy-libs/heliossqs
...
require (
	...
	github.com/helios/opentelemetry-go-contrib/instrumentation/github.com/aws/aws-sdk-go-v2/otelaws v0.0.0-20230129055622-7023939ccf9e
