module github.com/helios/go-sdk/proxy-libs/helioseventbridge

go 1.18

require (
	github.com/aws/aws-sdk-go-v2/service/eventbridge v1.17.1
	github.com/helios/opentelemetry-go-contrib/instrumentation/github.com/aws/aws-sdk-go-v2/otelaws v0.1.0
